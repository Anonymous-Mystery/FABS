...
This script benchmarks the four schemes across the following algorithms: Setup, Key Generation, Signing, Verification, The results are printed to the console and correspond to the performance claims made in the paper.
