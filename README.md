...
achieve linear-time key generation and signing, and require only two pairing operations in verification, which is the best known efficiency among
...
After Charm is installed and the virtual environment is activated, return to the
FABS project directory.
...
This script benchmarks the four schemes across the following algorithms:
- Setup
- Key Generation
- Signing
- Verification

The results are printed to the console and correspond to the performance claims
made in the paper.
...
Inline comments and function definitions explain the purpose of each component
and algorithmic step.
...
This artifact is released under the **MIT License**. See the `LICENSE` file for
details.
