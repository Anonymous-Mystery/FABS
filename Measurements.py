...
def measure_average_times_sp(ABS, attr_list, attr_policy, msg, N=5):  
    sum_setup = 0
    sum_keygen = 0
    sum_sign = 0
    sum_verify = 0
...
#-------------------------------------------------- run all module ------------------------------------------------------------
def run_sp(pairing_group, attr_list, policy_str, msg):  
    fabs_spabs = FABS_SPABS(pairing_group)
    fabs_spabs_time = measure_average_times_sp(fabs_spabs, attr_list, policy_str, msg)
...
def main():
    ...
    for policy_size in policy_sizes:
        for attr_size in attr_sizes:
            ...
            #run_sp(pairing_group, attr_list, policy_str, msg)
